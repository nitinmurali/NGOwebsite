...
<body>
  <body> 
    ...
    // Logged in successfully
        ...
        <h1 class="alert-heading">'.$success_message.'</h1>
        <p>Welcome back!!</p>
      </div>
      <button type="button" class="btn btn-lg btn-block btn-primary">
      <a href="donordetails.php" style="color:white;text-decoration:none;text-transform:uppercase;">View Donor Information</a></button>
      <button type="button" class="btn btn-lg btn-block btn-success">
      <a href="contactdetails.php" style="color:white;text-decoration:none;text-transform:uppercase;">View Volunteer Information</a></button>
