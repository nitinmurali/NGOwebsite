...
$link = mysqli_connect("localhost", "root", "", "contact_details");
...
$telephone = mysqli_real_escape_string($link, $_GET['telephone']);
  
//Inserting into database
$sql="INSERT INTO contact(first_name, last_name, email, address, message, telephone) VALUES ('$first_name', '$last_name', '$email', '$address', '$message', '$telephone')";
if(mysqli_query($link, $sql)){
    echo '<script>alert("Thank you for filling the form.");';
      ...
      <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="first-slide" src="./img/banner1.jpg" alt="First slide" width="1200px" height="400px">
            <div class="container">
          ...
          <div class="carousel-item">
            <img class="third-slide" src="./img/banner3.jpg" width="800px" alt="Third slide">
            <div class="container">
              <div class="carousel-caption text-left">
      ...
      <!--End Carousel-->
       ...
       <!--Causes section start-->
        ...
        <div class="row featurette" style="margin-top: -150px;">
         ...
         <ul class="list-group">
          <li class="list-group-item list-group-item-success"><img src="./icons/mail.png" alt="Mail"> <a href="https:/accounts.google.com" target="_blank" id="contact-link">nitinmurali05@gmail.com</a></li>
          <li class="list-group-item list-group-item-success"><img src="./icons/phone.png" alt="Phone"> <a href="tel:8217884293"  id="contact-link"> 8217884293</a></li>
          <li class="list-group-item list-group-item-success"><img src="./icons/location.png" alt="Location"> M.S Ramaiah City,4th Main,J.P Nagar 8th Phase,Bangalore,Karnataka,India<br>
